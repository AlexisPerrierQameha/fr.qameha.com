...
set :repository,  "git@github.com:darjeelink/fr.qameha.com.git"
set :scm, "git"
set :user, "spock"
...
task :copy_database_yml, :roles => :app do
  run "cp /home/spock/fr.qameha.com/database.yml #{release_path}/config/database.yml"
end


set :server_hostname, 'fr.qameha.com'
set :location, "204.232.206.121"
set :rails_env, "production"
set :deploy_to, "/home/spock/fr.qameha.com/"
set :port, 4800
